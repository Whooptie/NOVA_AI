...
| math.py | 🟡 Fase 1-3 volledig klaar, Fase 4-5 open | Berekeningen, temperatuurconversie, wiskundige functies, volledige Fase 3 Numerieke intelligentie (punt 7 Algebra, punt 8 Calculus, punt 9 Statistiek: gemiddelden/mediaan/modus, variantie, lineaire regressie, correlatie, kansberekeningen incl. binomiaal en normale verdeling) — zie math_roadmap.md |
...
4. 🟡 math.py Fase 4-5 afwerken — Fase 3 volledig af (2 aug 2026: punt 7
   Algebra, punt 8 Calculus, punt 9 Statistiek, alle drie getest in Nova
   zelf), in volgorde van math_roadmap.md:
