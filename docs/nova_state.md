...
4. 🟢 **Generieke actie-koppeling per Intent Classifier-categorie** — concept, nog niet ingepland (zie eigen sectie "💡 Idee (nog niet ingepland): generieke actie-koppeling per Intent Classifier-categorie" verderop voor het volledige voorstel en de reden om nu nog niet te bouwen).
