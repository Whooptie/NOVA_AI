...
7. 🟢 **Response Variant Learning** (response_variant_learning_roadmap.md) — nog volledig te bouwen, 2 fases, bewust los van elkaar:
...
`C:\Nova_AI\tests\`. Draaien vanuit de project-root: `pytest tests/ -v`. Stand 18 augustus 2026: **374 tests, allemaal groen** (~7s).
